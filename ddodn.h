// since I am reusing some code from w4od and running just a single
// Odrive controller I will comment out odrv_2 devices and retain
// odrv_3 devices...if I eventually install two more wheels and second
// Odrive I will bring back odrv_2 devices.
...
QT_BEGIN_NAMESPACE
namespace Ui { class ddodn; }
QT_END_NAMESPACE

class ddodn : public QMainWindow
{
    Q_OBJECT

public:
    ddodn(QWidget *parent = nullptr);
    ~ddodn();
...
//        QString odrv_2_serial_number = "2080377E5753";  // serial id first odrive
        QString odrv_3_serial_number = "3677385E3030";  // serial id 2nd purchased odrive
